...
namespace Easemob.XmppWebSocket
{
	...
	/// </summary>
	public class WSRosterManager
	{
		private readonly XmppWebSocketConnection	m_connection;
        ...
        public WSRosterManager(XmppWebSocketConnection con)
		{		
			m_connection = con;
            m_connection.OnRosterStart += new ObjectHandler(m_connection_OnRosterStart);
            m_connection.OnRosterEnd += new ObjectHandler(m_connection_OnRosterEnd);
            m_connection.OnRosterItem += new XmppClientConnection.RosterHandler(m_connection_OnRosterItem);
		}
        ...
        #region rosterµÄ´æ´¢¹ÜÀí
        
        /// <summary>
        /// 
        /// </summary>
        private List<RosterItem> rosterList = new List<RosterItem>();

        void m_connection_OnRosterItem(object sender, RosterItem item)
        {

        }

        void m_connection_OnRosterEnd(object sender)
        {

        }

        void m_connection_OnRosterStart(object sender)
        {
