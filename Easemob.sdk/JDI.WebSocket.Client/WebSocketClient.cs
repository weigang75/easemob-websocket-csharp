...
using Easemob.Common;
using Easemob.Common.Extensions;
using Easemob.Common.Logger;
using Easemob.Common.Net;
using Easemob.Common.Security;
using Easemob.Common.Utils;
	...
	public class WebSocketClient : IDisposable
	{
		...
		public WebSocketClient(string logSourceID, WSOptions options = null)
		{
			...
			try
			{
                ...
                this.stateMachineThread.IsBackground = true;
		...
		public void Connect(string serverUrl)
		{
			if (this.State == WebSocketState.Initialized || this.State == WebSocketState.Disconnected)
			{
				...
				//	IPAddress ipAddress = hostEntry.AddressList[0];
					...
					{
						this.OnError(WSErrorCode.NativeError, string.Concat("Host not found: ", this.serverUri.Host));
						return;
					}
		...
		protected void DoConnected()
		{
			...
			this.subState = SubState.ReceiveStart;
		}
		...
		protected void DoReceiveStart()
		{
			...
			this.subState = SubState.Receiving;
		}
